        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            ...
            <form action="#" className="flex flex-col gap-y-4">
              ...
              />
              <textarea
                className="border border-gray-300 focus:border-violet-700 outline-none w-full resize-none rounded p-4 h-36 text-sm text-gray-400"
                placeholder="Message*"
                defaultValue={"Hello, Im interested in [Modern apartament]"}
              ></textarea>
              <div className="flex gap-x-2">
                <button className="bg-violet-700 hover:bg-violet-800 text-white p-4 rounded text-sm w-full transition">
                  Send Message
                </button>
